...
**相关基础技术：** Schema Priming, Negative Space, Cognitive Offloading（见 [prompt-engineering-for-skills.md](/prompt-context-patterns/catalog/techniques/token-level-techniques)）
