...
**出现频率：** `ralph-loop` 插件中独立的编排模型；可推广
**相关模式：** [Hook-Driven Automation](/prompt-context-patterns/catalog/categories/patterns-claude-code-platform-zh#pattern-132-hook-driven-automation-awareness), [Loop Prevention with Max Iterations](/prompt-context-patterns/catalog/categories/patterns-advanced-orchestration-zh#pattern-41-loop-prevention-with-max-iterations)
