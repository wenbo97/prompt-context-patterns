...
**相关基础技术：** Grounding/Anchoring, Few-Shot with Embedded Reasoning, Attention Locality（见 [prompt-engineering-for-skills.md](/prompt-context-patterns/catalog/techniques/token-level-techniques-zh)）
