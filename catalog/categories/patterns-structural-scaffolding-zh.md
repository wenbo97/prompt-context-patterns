...
**相关基础技术：** Schema Priming, XML Tags for Semantic Boundaries（见 [prompt-engineering-for-skills.md](/prompt-context-patterns/catalog/techniques/token-level-techniques-zh)）
