...
A reference library for writing stable, predictable prompts for Claude Code skills and plugins. Contains **155 prompt engineering patterns** extracted from 500+ production AI agent plugins (community plugin marketplace), Anthropic's official skills repo, community open-source skills, the Claude Code system prompt, and a 2026-05 harvest across awesome-claude-skills + superpowers + claude-plugins-official + internal experiments.
...
#### Platform Patterns (121-142)

| File | Patterns | Source |
|------|----------|--------|
| [patterns-claude-code-platform.md](/prompt-context-patterns/catalog/categories/patterns-claude-code-platform) | 121-132 | Claude Code system prompt — core platform concerns |
| [patterns-claude-code-platform-extended.md](/prompt-context-patterns/catalog/categories/patterns-claude-code-platform-extended) | 133-142 | Claude Code system prompt — extended (composition, sub-agents, security, memory) |

#### Harvest 2026-05 (143-155)

13 patterns added in the 2026-05 harvest across awesome-claude-skills + superpowers + claude-plugins-official + internal experiments. Distributed across existing category files; see the [catalog index](/prompt-context-patterns/catalog/catalog-index#category-17-harvest-2026-05-patterns-143-155) for the full table and links.
